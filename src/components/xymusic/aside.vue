    ...
    <el-menu class="el-menu-vertical-demo"
      ...
      <el-submenu index="1"
        ...
        <el-menu-item :index="'/home/playlistpage/' + item.id"
               ...
               alt="" />{{ item.name }}</el-menu-item>
        <el-menu-item :index="'/home/playlistpage/' + item.id"
                      class="otheritem"
                      v-for="(item) in playListMine == null ? [] : playListMine.slice(1, playListMine.length - 1)"
                      :key="item.id"><img src="../../assets/images/音乐.svg"
               alt="" />{{ item.name }}</el-menu-item>
      </el-submenu>
      <el-submenu index="2"
                  ref="menu">
